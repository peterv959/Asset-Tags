...
export const LabelForm: React.FC<LabelFormProps> = ({ onBlur, isLoading = false, assetTagRef, disableSerialNumber = false }) => {
        ...
        <form className="label-form" onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="form-group">
                ...
                <input
                    ...
                    disabled={isLoading || disableSerialNumber}
                    title={disableSerialNumber ? 'Serial numbers are not supported for consecutive labels' : ''}
                />
